...
import { Slide, ViewMore, BaseHeader } from 'layout'
            ...
            <TouchableWithoutFeedback style= { { flex:1}} onPress={() =>this.props.navigation.closeDrawer()}>
                <ScrollView>
                    ...
                    <View style={style.heading}>
                        ...
                        <ViewMore onPress={() => this.props.navigation.navigate(ScreenName.ViewAllProduct, {title: "Sản phẩm nổi bật"})}/>
                    </View>
                    ...
                    <View style={style.heading}>
                        ...
                        <ViewMore  onPress={() => this.props.navigation.navigate(ScreenName.ViewAllProduct, {title: "Sản phẩm mới nhất"})}/>
                    </View>
                    <ListItem data={data} navigate={this.props.navigation.navigate} />
                    <View style={style.hr}></View>
                    ...
                    <View style={style.heading}>
                        ...
                        <ViewMore onPress={() => this.props.navigation.navigate(ScreenName.ViewAllProduct, {title: "Sản phẩm bán chạy"})} />
                    </View>
